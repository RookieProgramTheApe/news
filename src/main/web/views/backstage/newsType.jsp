            ...
            <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <!-- 个人信息 -->
                        <li class="nav-item dropdown">
                            <a id="languages" href="${pageContext.request.contextPath}/userinfo?id=${sessionScope.id}" aria-haspopup="true" aria-expanded="false" class="nav-link language">
                ...
                <div class="card">
                    <div class="card-body">
                        <c:forEach var="item" items="${requestScope.result}">
                            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/changeNewsType">
                                <input type="text" name="id" value="${item.id}"  hidden="hidden">
                                <div class="form-group row">
                                    <label class="col-sm-2 form-control-label">新闻类型名称</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" value="${item.newsType}" name="newsType">
                                    </div>
                                    <div class="col-sm-3">
